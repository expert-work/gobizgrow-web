                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-toolbar">
                            <div class="btn-group pull-right">
                                <a href="{{url('shop-admins/new')}}" type="button" class="btn btn-fit-height grey-salt "   data-delay="1000" data-close-others="true"> New
                                 </a>
                                        ...
                                        <table class="table table-striped table-bordered table-advance table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                            <a href="{{url('customers/edit/'.$user->id)}}" class="btn btn-outline btn-circle btn-sm purple">
                                                               <i class="fa fa-edit"></i> Edit 
                                                            </a>
                                                             <a href="javascript:void(0)" onclick="deleteCustomer({{ $user->id }})"  class="btn btn-outline btn-circle dark btn-sm black">
