...
<head>
    <meta charset="utf-8">
    <title>{{$Invoice->invoice_number}} : {{$Customer->name}}</title>
    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
                            ...
                            <td>
                                ...
                                <div style="width: 250px;  float: right;">
                                   ...
                                   <tr style="padding: 0;margin: 0">
                                       <td width="60%" style="text-align: left;padding: 0;margin: 0; line-height: 18px">Invoice Number</td>
                                       <td width="40%"  style="padding: 0;margin: 0; line-height: 18px">{{$Invoice->invoice_number}}</td>
                                   </tr>

                                   <tr style="padding: 0;margin: 0">
                                       <td style="text-align: left;padding: 0;margin: 0; line-height: 18px">Invoice Date</td>
                                       <td style="padding: 0;margin: 0; line-height: 18px">{{ date('m/d/Y', strtotime($Invoice->invoice_date)) }}</td>
                                   </tr>

                                   <tr style="padding: 0;margin: 0">
                                       <td style="text-align: left;padding: 0;margin: 0; line-height: 18px">Due date</td>
                                       <td style="padding: 0;margin: 0; line-height: 18px">{{ date('m/d/Y', strtotime($Invoice->due_date)) }} </td>
                                   </tr>                                   
            ...
            <tr class="total">
                <td></td><td></td>
                <td style="text-align: right;">
                   Sub Total: {{usaCurrencyFormat($Invoice->sub_total)}}
                </td>
            </tr>
            <tr class="total">
                <td></td><td></td>
                <td style="text-align: right;">
                   Discount: {{usaCurrencyFormat($Invoice->discount_val)}}
                </td>
            </tr>
           ...
           @endforeach
            ...
            <tr class="item">
                <td></td><td></td>
                <td style="text-align: right;">
                   <b>Total</b>: {{usaCurrencyFormat($Invoice->total)}}
                </td>
            </tr>
