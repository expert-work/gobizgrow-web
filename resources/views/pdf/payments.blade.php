...
<head>
    <meta charset="utf-8">
    <title>{{$Payment->payment_number}} : {{$Customer->name}}</title>
                            ...
                            <td>
                                ...
                                <div style="width: 250px;  float: right;">
                                   ...
                                   <tr style="padding: 0;margin: 0">
                                       <td width="60%" style="text-align: left;padding: 0;margin: 0; line-height: 18px">Payment Number</td>
                                       <td width="40%"  style="padding: 0;margin: 0; line-height: 18px">{{$Payment->payment_number}}</td>
                                   </tr>

                                   <tr style="padding: 0;margin: 0">
                                       <td style="text-align: left;padding: 0;margin: 0; line-height: 18px">Payment Date</td>
                                       <td style="padding: 0;margin: 0; line-height: 18px">{{ date('m/d/Y', strtotime($Payment->payment_date)) }}</td>
                                   </tr>
