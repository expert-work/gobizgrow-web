...
<form  action="{{url('invoices/edit/'.$invoice->auth_token)}}" method="post"  enctype="multipart/form-data" onsubmit="return formValidation();" >
                                       {{ csrf_field() }}
                                        <div class="form-body">
                                 <div class="row" style="    padding-top: 40px !important;padding: 20px;">     
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                   <div class="input-group input-medium date date-picker_2" data-date-format="mm/dd/yyyy" data-date-start-date="+0d">
                                                        <input type="text" class="form-control" readonly="" id="invoice_date" name="invoice_date" value="{{date('m/d/Y',strtotime($invoice->invoice_date))}}" >
                                      ...
                                      <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                   <div class="input-group input-medium date date-picker_2" data-date-format="mm/dd/yyyy" data-date-start-date="+0d">
                                                        <input type="text" class="form-control" readonly="" id="due_date" name="due_date" value="{{date('m/d/Y',strtotime($invoice->invoice_date))}}" >
                                                        <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="invoice_number" id="invoice_number" value="{{$invoice->invoice_number}}" class="form-control" placeholder="123453"> 
                                                </div>
                                            </div>
...
<div class="itmes_container">
   ...
   <?php
    ...
    <div class="new_item_rows">
        ...
        @foreach($invoiceItems as $key=>$firstItem)
         @if($key)
            <?php
                $uniqIdFromSec= 'it'.rand().rand().rand();
                $uniqIdFromSecArray[]=$uniqIdFromSec;
             // 'name', 'price', 'quantity', 'total', 'invoice_id', 'item_id', 'company_id',
            //       print_r($firstItem);
                ?>
...
<!-- ============================Add New Items End================================ -->
                                        ...
                                        <div class="row" style="margin: 0;margin-top: 40px">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                     <label>Notes</label>
                                                     <textarea class="form-control" rows="5" name="notes">{{$invoice->notes}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                 <div style="padding: 10px;padding: 10px;background: #d4d5d6; margin-top: 24px;font-size: 16px;line-height: 24px;">
                                                     <div class="row">
                                                         ...
                                                         <div class="col-md-5 col-sm-5 col-xs-5"><input type="hidden" name="sub_total" value="{{$invoice->sub_total}}" id="sub_total"> $<span class="sub_total">{{$invoice->sub_total}}</span></div>
                                                     </div>
                                                      <hr>
                                                     <div class="row">
                                                         <div class="col-md-7 col-sm-7 col-xs-7"><span>DISCOUNT</span></div>
                                                         <div class="col-md-5 col-sm-5 col-xs-5"><input type="text"  onchange="calCulate()"   onkeyup="calCulate()" value="{{$invoice->discount}}"  name="discount" id="discount"  style="width: 50px" onkeypress="return isNumberKey(event)">
                                                            <select style="width: 60px;height: 30px;"  onchange="calCulate()" name="discount_type" id="discount_type" >
                                                                <option @if($invoice->discount_type =='Fixed') selected @endif>Fixed</option> 
                                                                <option @if($invoice->discount_type =='Percentage') selected @endif>Percentage</option>
                                                            </select>
                                                         </div>
                                                         <input type="hidden" name="discount_val" id="discount_val" value="{{$invoice->discount_val}}">
                                                     </div>
                                                     ...
                                                     <div class="row">
                                                       ...
                                                       <div class="row" style="    margin-top: 20px;padding: 15px;background: white;color: #3798dc;font-size: 18px;font-weight: 700;">
                                                         ...
                                                         <div class="col-md-5 col-sm-5 col-xs-5"><input type="hidden" name="total" id="total_amount" value="{{$invoice->total}}"> $<span class ="total_amount">{{$invoice->total}}</span></div>
                                                     </div>
...
<script type="text/javascript">
 var InvoiceImage= <?php echo  json_encode($InvoiceImage); ?>;
...
<script type="text/javascript">
    ...
    var ALL_TAXES=[];
    var SELECTED_TAXES=<?php  echo json_encode($Invoice_tax); ?>;
...
function generateSelectedTaxesHtml(){
  ...
  @if(isset($InvoiceImage))
           InvoiceImage.map(function (item) {
