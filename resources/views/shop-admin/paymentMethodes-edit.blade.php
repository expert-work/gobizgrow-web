                            ...
                            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <div class="d-flex align-items-center flex-wrap mr-2">
                                    ...
                                    <!--begin::Actions-->
                                     ...
                                     <a href="{{url('payment-methods')}}" class="btn btn-light-warning font-weight-bolder btn-sm"> payment Methods</a>
                                    <!--end::Actions-->
                                </div>
                                <!--end::Info-->
                                <!--begin::Toolbar-->
...
<!-- ////////////////////////////////////////////////////////////////////////////////////// -->
 ...
 <form  action="{{url('/payment-methods/edit/'.$paymentMethod->auth_token)}}" method="post">
                                       {{ csrf_field() }}
                                        <div class="form-body">
                                             <div class="col-md-6">
