...
<!-- ////////////////////////////////////////////////////////////////////////////////////// -->
    ...
    <div class="card-body form">
                                    <form  action="{{url('customers/edit/'.$customer->auth_token)}}" method="post">
                                       {{ csrf_field() }}
                                        <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input  type="email" name="email" value="{{$customer->email}}"  class="form-control" placeholder="Email Address"> </div>
                                                      @error('email')
                                            ...
                                            <div class="form-group">
                                                <label>Street Address</label>
                                                 <div class="input-group">
                                                    ...
                                                    <input type="text" name="street_address" value="{{$customer->street_address}}" class="form-control" placeholder="Street Address"> 
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label>Zip Code</label>
                                                 <div class="input-group">
                                                    ...
                                                    <input type="text" name="zip_code" value="{{$customer->zip_code}}" class="form-control" placeholder="Zip Code"> 
                                                </div>
                                                @error('zip_code')
                                                        <span class="invalid-feedback" style="color:red" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group">
                                                <label>Customer Notes</label>
                                                 <textarea class="form-control" name="customer_notes">{{$customer->customer_notes}}</textarea>
                                ...
                                <input type="hidden" name="vehicles_json_data" id="vehicles_json_data" value="<?php echo json_encode($vehicles); ?>">
                                       </div>
                                          <div class="form-group">
                                               <div class="input-group">
