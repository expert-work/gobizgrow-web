...
<!-- ////////////////////////////////////////////////////////////////////////////////////// -->
  ...
  <form  action="{{url('expenses/new')}}" method="post"  enctype="multipart/form-data" >
                                       {{ csrf_field() }}
                                        <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                   <div class="input-group input-medium date date-picker" data-date-format="mm/dd/yyyy" data-date-start-date="+0d">
                                                        <input type="text" class="form-control" readonly="" name="expense_date" value="{{(null !==old('expense_date'))?old('expense_date'):date('m/d/Y')}}" >
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="amount"  value="{{old('amount')}}" class="form-control currency_input" placeholder="Amount"> 
                                                </div>
                                            </div>
                                             @error('amount')
                                                <span class="invalid-feedback" style="color:red" role="alert">
                                                      ...
                                                      <div class="input-group">
                                                         <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div class="input-group input-large">
                                                                        ...
                                                                        <input type="hidden" value="" name="..."><input type="file" name="receipt"> 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label >Notes</label>
                                                <textarea class="form-control" placeholder="Notes" name="notes">{{old('notes')}}</textarea>
                                             </div>
                                            @error('notes')
                                                        <span class="invalid-feedback" style="color:red" role="alert">
                                                            <strong>{{ $message }}</strong>
