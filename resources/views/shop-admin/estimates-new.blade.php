...
<div class="col-lg-12"> 
    <div class="card card-custom card-stretch gutter-b"> 
       <div class="card-body pt-0 pb-3">
                         ...
                         <form  action="{{url('estimates/new')}}" method="post"  enctype="multipart/form-data" onsubmit="return formValidation();" >
                                       {{ csrf_field() }}
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                   <div class="input-group input-medium date date-picker_1" data-date-format="mm/dd/yyyy" data-date-start-date="+0d">
                                                        <input type="text" class="form-control" readonly="" id="estimate_date" name="estimate_date" value="{{(old('estimate_date') !==null)?old('estimate_date'):date('m/d/Y')}}" >
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="estimate_number" id="estimate_number" value="{{(old('estimate_number') !==null)?old('estimate_number'):$estimate_number}}" class="form-control" placeholder="123453"> 
