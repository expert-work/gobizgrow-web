                            ...
                            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <div class="d-flex align-items-center flex-wrap mr-2">
                                    ...
                                    <!--begin::Actions-->
                                     ...
                                     <a href="{{url('categories')}}" class="btn btn-light-warning font-weight-bolder btn-sm"> Categories</a>
                                    <!--end::Actions-->
                                </div>
                                <!--end::Info-->
                                <!--begin::Toolbar-->
...
<!-- ////////////////////////////////////////////////////////////////////////////////////// -->
    ...
    <div class="card-body form">
                                        <form  action="{{url('categories/edit/'.$category->auth_token)}}" method="post">
                                       {{ csrf_field() }}
                                        <div class="row">
                                             <div class="col-md-6">
