...
<!-- ////////////////////////////////////////////////////////////////////////////////////// -->
    ...
    <div class="card-body form">
                                    <form  action="{{url('items/new')}}" method="post">
                                       {{ csrf_field() }}
                                        <div class="row">
                                             <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control currency_input" placeholder="Price" name="price">
                                    ...
                                    @endif
                                      ...
                                      <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                               <div class="input-group">
                                                 <button style="min-width: 300px;    margin-top: 40px; margin-left: 15px;" type="submit"  class="btn btn-primary">Submit</button>
                                             </div>
                                         </div>
