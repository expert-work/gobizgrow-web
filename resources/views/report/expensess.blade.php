                                   ...
                                   ?>
                                       ...
                                       <div class="col-md-6">
                                         <label>Select Date Range</label>     
                                              <div class='input-group' id='kt_daterangepicker_6' data-date-format="mm/dd/yyyy">
...
@section('script')
    ...
    <script type="text/javascript">
         function filterFuncton(){
               ...
               var url= '{{url('pdf/reports/expensess?company_id='.Auth::user()->company_id)}}&range='+range;
