                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td align="center" valign="top">
                                                <table border="0" cellpadding="0" cellspacing="0" width="600" class="templateContainer">
                                                    <tr>
                                                        <td valign="top" class="headerContainer" style="padding-top:10px; padding-bottom:10px;"></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
...
<table align="right" border="0" cellpadding="0" cellspacing="0" class="mcnImageCardTopContent" width="100%" style="background-color: #0C54B3;border: 1px none;">
    <tbody><tr>
        <td class="mcnTextContent" valign="top" style="padding: 18px 18px 0px;color: #FFFFFF;font-size: 30px;font-weight: bold;line-height: 100%;text-align: justify;" width="546">
            &nbsp;
<h1><span style="font-family:verdana,geneva,sans-serif">You nailed it!&nbsp;</span></h1>
    ...
    <tr>
        <td class="mcnImageCardTopImageContent" align="center" valign="top" style="padding-top:9px; padding-right:0px; padding-bottom:0px; padding-left:0px;">
            ...
            <img alt="" src="https://mcusercontent.com/022f8d7fcd3b836285ecd9cff/images/1343c252-f778-456e-8d9b-6f29e5fba550.png" width="562" style="max-width: 1200px; border: 1px none; border-radius: 0%;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: center;"><span style="font-size:22px">You're well on your way to taking your business to the next level. We're here for you if you need us.&nbsp;<br>
<img data-file-id="1804430" height="65" src="https://mcusercontent.com/022f8d7fcd3b836285ecd9cff/images/e1890a50-da41-48fe-9843-6ac912771b1c.png" style="border: 0px  ; width: 179px; height: 65px; margin: 0px;" width="179"></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <a href="http://www.gobizgrow.com" target="_blank">support@gobizgrow.com</a>
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
    ...
    <tbody class="mcnDividerBlockOuter">
        <tr>
            <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 24px 18px;">
                <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;border-top: 2px double #EAEAEA;">
                    <tbody><tr>
                        <td>
                            <span></span>
                        </td>
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #297C08;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 18px; padding: 14px;">
                                <a class="mcnButton " title="Upgrade Membership " href="https://app.gobizgrow.com/register" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Upgrade Membership </a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                                                                ...
                                                                <td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                    <a href="http://www.yourwebsite.com" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-link-48.png" alt="Website" style="display:block;" height="24" width="24" class=""></a>
                                                                                </td>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <em>Copyright © 2020 GoBizGrow, All rights reserved.</em><br>
<br>
<strong>Our mailing address is:</strong><br>
5324 Twin Hickory Rd Glen Allen, VA 23059<br>
