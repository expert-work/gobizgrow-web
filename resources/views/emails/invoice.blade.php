                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnBoxedTextContentContainer">
                    <tbody><tr>
                        ...
                        <td style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:18px;">
                            ...
                            <table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #EAEAEA;">
                                <tbody><tr>
                                    <td valign="top" class="mcnTextContent" style="padding: 18px;color: #000000;font-size: 16px;text-align: center;">
                                        <div style="text-align: center;">Hi {{$customer->name}},&nbsp;</div>
&nbsp; &nbsp; &nbsp;Thank you for choosing {{$company->name}}. A detailed invoice for the work done on your vehicle is attached to this email. If you have any questions or concerns, please let me know. We sincerely appreciate your business and hope to serve you again in the future.&nbsp;<br>
<br><br>
<center>Download Link: <a style="color: blue" href="{{url('invoice-pdf/'.$invoice->auth_token)}}">{{url('invoice-pdf/'.$invoice->auth_token)}}</a></center>
<br><br>
{{$company->name}}
                                    </td>
                                </tr>
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-size: 14px; line-height: 200%; text-align: center;">
