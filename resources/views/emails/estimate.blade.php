                            ...
                            <table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #EAEAEA;">
                                <tbody><tr>
                                    <td valign="top" class="mcnTextContent" style="padding: 18px;color: #000000;font-size: 16px;text-align: center;">
                                        <div style="text-align: center;"><span style="font-size:20px">Hi {{$customer->name}},&nbsp;</span></div>

<div style="text-align: center;">&nbsp;</div>

<div style="text-align: center;"><span style="font-size:20px">I have attached an estimate for the work needed on your vehicle.&nbsp;<br>
&nbsp;I appreciate the opportunity to asses your vehicle and would be happy to earn your business. If you have any questions about the estimate, please don't hesitate to contact me.&nbsp;<br><br>
<center>Download Link: <a style="color: blue" href="{{url('estimate-pdf/'.$estimate->auth_token)}}">{{url('estimate-pdf/'.$estimate->auth_token)}}</a></center>
<br><br>
{{$user->name}}</span></div>
